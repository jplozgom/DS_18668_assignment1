...
class SystemSmells(Enum):
    ...
    def description(self):
        if(self == SystemSmells.DATA_CLASS):
    ...
    @staticmethod
    def getList():
        return list(map(str, SystemSmells))
